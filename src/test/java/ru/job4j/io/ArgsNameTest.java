...
class ArgsNameTest {
    ...
    @Test
    void whenGetException() {
        assertThatThrownBy(() -> ArgsName.of(new String[] {"Xmx=512", "-encoding=UTF-8"}))
                .isInstanceOf(IllegalArgumentException.class);
    }

    @Test
    void whenGetExceptionForNoKey() {
        assertThatThrownBy(() -> ArgsName.of(new String[] {"-=512"}))
                .isInstanceOf(IllegalArgumentException.class);
    }

    @Test
    void whenGetExceptionForNoKeyAndValue() {
        assertThatThrownBy(() -> ArgsName.of(new String[] {"-encodingUTF-8"}))
                .isInstanceOf(IllegalArgumentException.class);
    }

    @Test
    void whenGetExceptionForNoValue() {
